...
public class ColorsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        words.add(new Word("yellow", "haladi", R.drawable.color_mustard_yellow, R.raw.color_yellow));
        ...
        words.add(new Word("gray", "budu", R.drawable.color_gray, R.raw.color_gray));
        words.add(new Word("black", "kappu", R.drawable.color_black, R.raw.color_black));
        words.add(new Word("white", "bili", R.drawable.color_white, R.raw.color_white));
