...
public class FamilyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        words.add(new Word("Younger brother", "Thamma", R.drawable.family_younger_brother,R.raw.young_brother));
        words.add(new Word("Elder sister", "Akka", R.drawable.family_older_sister,R.raw.elder_sister));
        words.add(new Word("Younger sister", "Thangi", R.drawable.family_younger_sister,R.raw.young_sister));
        ...
        words.add(new Word("Wife", "Hendathi", R.drawable.family_mother,R.raw.wife));
        words.add(new Word("Husband", "Ganda", R.drawable.family_father,R.raw.husband));
